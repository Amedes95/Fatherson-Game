...
public class MovingPlatform : MonoBehaviour
{
    ...
    private void Awake()
    {
        transform.position = MoveLocations[0].position; // start the platform at the first node
    ...
    void Update()
    {
        gameObject.GetComponent<Rigidbody2D>().velocity = TargetPosition.position; // constantly move the blade to the target position
