    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.tag == "Player")
        {
            if (SceneManager.GetActiveScene().name == "Tutorial_20") // if its the last level of the tutorial
            {
                ...
                if (PlayerData.PD.AchievementRecords.ContainsKey("Baby Steps") == false) // not already unlocked?
                {
                    PlayerData.PD.AchievementRecords.Add("Baby Steps", 1);
            ...
            if (SceneManager.GetActiveScene().name == "W1BOSS") // w1 boss beaten, unlock cheevo
            {
                ...
                if (PlayerData.PD.AchievementRecords.ContainsKey("Flea Flee") == false) // not already unlocked?
                {
                    PlayerData.PD.AchievementRecords.Add("Flea Flee", 1); // add to unlock dictionary
            ...
            if (SceneManager.GetActiveScene().name == "W2BOSS") // w2 boss beaten, unlock cheevo
            {
                ...
                if (PlayerData.PD.AchievementRecords.ContainsKey("Spoiled Appetite") == false) // not unlocked already?
                {
                    PlayerData.PD.AchievementRecords.Add("Spoiled Appetite", 1); // not unlocked already?
            ...
            {
                if (PlayerData.PD.AchievementRecords.ContainsKey("Party Crasher") == false) // not unlocked already?
                {
                    PlayerData.PD.AchievementRecords.Add("Party Crasher", 1); // add to unlock dictionary
                    Debug.Log("Party Crasher Unlocked");
                    BackgroundMusic BGMusic = GameObject.FindGameObjectWithTag("BGMusic").GetComponent<BackgroundMusic>();
                    BGMusic.UnlockCheevo("Party Crasher");
                    PlayerData.PD.PartyUnlocked = 1;
                }
            ...
            {
                if (PlayerData.PD.AchievementRecords.ContainsKey("Fossilized") == false) // not unlocked already?
                {
                    PlayerData.PD.AchievementRecords.Add("Fossilized", 1); //add to unlock dictionary
                    Debug.Log("Fossilized Unlocked");
                    BackgroundMusic BGMusic = GameObject.FindGameObjectWithTag("BGMusic").GetComponent<BackgroundMusic>();
                    BGMusic.UnlockCheevo("Fossilized");
                    PlayerData.PD.OldTimeyUnlocked = 1;
                }
            ...
            if (SceneManager.GetActiveScene().name == "W3BOSS") // w3 boss beaten, unlock cheevo
            {
                ...
                if (PlayerData.PD.AchievementRecords.ContainsKey("Fungus Among Us") == false) // not unlocked already?
                {
                    PlayerData.PD.AchievementRecords.Add("Fungus Among Us", 1); // add to unlock dictionary
            ...
            if (SceneManager.GetActiveScene().name == "W4BOSS") // w4 boss beaten, unlock cheevo
            {
                ...
                if (PlayerData.PD.AchievementRecords.ContainsKey("Ghastly Escape") == false) // not unlocked already?
                {
                    PlayerData.PD.AchievementRecords.Add("Ghastly Escape", 1); // add to unlock dictionary
            ...
            if (SceneManager.GetActiveScene().name == "W5BOSS") // w5 boss beaten, unlock cheevo
            {
                ...
                if (PlayerData.PD.AchievementRecords.ContainsKey("Frostbitten") == false) // not unlocked already?
                {
                    PlayerData.PD.AchievementRecords.Add("Frostbitten", 1);
            ...
            if (SceneManager.GetActiveScene().name == "W6BOSS") // w6 boss beaten
            {
                ...
                if (PlayerData.PD.AchievementRecords.ContainsKey("Hippidy Hoppidy") == false) // not unlocked already?
                {
                    PlayerData.PD.AchievementRecords.Add("Hippidy Hoppidy", 1); // add to unlock dictionary
            ...
            {
                PlayerData.PD.GoldWorld_Complete = 1;
                // unlocks Ancient Evil achievement
                if (PlayerData.PD.AchievementRecords.ContainsKey("Ancient Evil") == false) // not unlocked already?
                {
                    PlayerData.PD.AchievementRecords.Add("Ancient Evil", 1); // add to unlock dictionary
            ...
            if (PlayerData.PD.AchievementRecords.ContainsKey("Vegetarian") == false && PlayerPrefs.GetInt("Flawless Run") == 0) // not unlocked already?
            {
                PlayerData.PD.AchievementRecords.Add("Vegetarian", 1); // add to unlock dictionary
            ...
            if (WorldNumber == 1) // last non-boss level in world 1
            {
                ...
                if (PlayerData.PD.AchievementRecords.ContainsKey("Snake charmer") == false) // not unlocked already?
                {
                    PlayerData.PD.AchievementRecords.Add("Snake charmer", 1); // add to unlock dictionary
            ...
            else if (WorldNumber == 2)
            {
                ...
                if (PlayerData.PD.AchievementRecords.ContainsKey("World Wide Web") == false) // not unlocked already?
                {
                    PlayerData.PD.AchievementRecords.Add("World Wide Web", 1); // add to unlock dictionary
            ...
            else if (WorldNumber == 3)
            {
                ...
                if (PlayerData.PD.AchievementRecords.ContainsKey("Synthetic Scientist") == false) // not unlocked already?
                {
                    PlayerData.PD.AchievementRecords.Add("Synthetic Scientist", 1); // add to unlock dictionary
            ...
            else if (WorldNumber == 4)
            {
                ...
                if (PlayerData.PD.AchievementRecords.ContainsKey("Hot Topic") == false) // not unlocked already?
                {
                    PlayerData.PD.AchievementRecords.Add("Hot Topic", 1); // add to unlock dictionary
            ...
            else if (WorldNumber == 5)
            {
                ...
                if (PlayerData.PD.AchievementRecords.ContainsKey("Cold Shoulder") == false) // not unlocked already?
                {
                    PlayerData.PD.AchievementRecords.Add("Cold Shoulder", 1); // add to unlock dictionary
            ...
            else if (WorldNumber == 6)
            {
                ...
                if (PlayerData.PD.AchievementRecords.ContainsKey("The End?") == false) // not unlocked already?
                {
                    PlayerData.PD.AchievementRecords.Add("The End?", 1); // add to unlock dictionary
                    Debug.Log("The End?");
                    BackgroundMusic BGMusic = GameObject.FindGameObjectWithTag("BGMusic").GetComponent<BackgroundMusic>();
